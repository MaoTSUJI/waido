...
{{-- 				<img class="mb-3 miyakomap" src=img/miyakomap.png alt="マップ" usemap="miyako" width="80%" >
				...
				<img id="quizmap" style="border:solid;" class="miyakomap" src=img/miyakomap.png alt="マップ" usemap="#image-map" width="80%" >
				<map name="image-map">
				  ...
				  <area shape="rect" coords="4,6,207,162" href="#" alt="" />
			    <area shape="rect" coords="790,479,997,737" href="#" alt="" />
